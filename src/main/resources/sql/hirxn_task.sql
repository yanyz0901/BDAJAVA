...
CREATE TABLE `hirxn_task`  (
  ...
  `rxn_smiles` varchar(5000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT '反应表达式',
  ...
  `rxn_tokens` varchar(5000) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '反应token结果',
